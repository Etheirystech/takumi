...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`border`</td>
      <td>`borderWidth` (`borderTopWidth`, `borderRightWidth`, `borderBottomWidth`, `borderLeftWidth`, `borderInlineWidth`, `borderBlockWidth`), `borderStyle`, `borderColor`</td>
      <td>Only `solid`, `none` style is supported</td>
    </tr>
    <tr>
      <td>`borderRadius`</td>
    ...
    <tr>
      <td>`outline`</td>
      <td>`outlineWidth`, `outlineStyle`, `outlineColor`, `outlineOffset`</td>
      <td>Only `solid`, `none` style is supported</td>
    </tr>
    <tr>
